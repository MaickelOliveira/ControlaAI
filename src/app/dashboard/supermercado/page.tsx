    ...
    <div className="space-y-5">
      ...
      {tab === "lista" && (
        <div className="space-y-4">
          ...
          <div>
            <p className="text-xs font-semibold text-slate-500 mb-2">Filtrar os itens que já estão na sua lista</p>
          ...
          {!listFilter && (
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4">
              <p className="text-sm font-semibold text-slate-700">Escolha produtos por categoria</p>
              <p className="text-xs text-slate-400 mt-1 mb-3">Abra uma categoria, marque os produtos desejados e confirme. Nada é adicionado automaticamente.</p>
