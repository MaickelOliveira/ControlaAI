...
export default function MetasPagePt() {
    ...
    <div className="space-y-5">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-12 text-center shadow-sm">
          ...
          <p className="text-sm text-slate-400 mt-1">Define um objetivo e acompanha o teu progresso!</p>
              ...
              <div key={goal.id} className="group bg-white rounded-2xl border border-slate-100 shadow-sm p-5 hover:shadow-md transition">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">{goal.category}{goal.deadline && ` · Prazo: ${new Date(goal.deadline + "T12:00:00").toLocaleDateString("pt-PT")}`}</p>
                  </div>
