      ...
      <div className="relative w-[300px] shrink-0 mx-auto rounded-[3rem] border-[7px] border-slate-900 bg-slate-900 shadow-2xl overflow-hidden transition-transform hover:rotate-0" style={{ transform: tilt ? `rotate(${tilt}deg)` : undefined }}>
        ...
        <div className="bg-white px-3 py-2.5 flex items-center gap-2.5 border-b border-slate-100">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-slate-400 text-[10.5px] leading-tight">{typing ? "a escrever..." : "online agora"}</p>
          </div>
    ...
    <div ref={ref} className="max-w-sm mx-auto space-y-3 relative">
      ...
      <div className={clsx("rounded-2xl border bg-white p-4 flex items-center gap-3 transition-all duration-500", stage === 1 ? "border-amber-300 shadow-xl -translate-y-1" : "border-slate-100 shadow-sm")}>
        ...
        <div className="min-w-0">
          <p className="text-sm font-semibold text-slate-800 truncate">Reunião com toda a equipa</p>
      ...
      <div className={clsx("rounded-2xl border p-4 flex items-center gap-3 transition-all duration-500", stage === 2 ? "border-slate-800 bg-slate-950 text-white shadow-xl translate-y-0 opacity-100" : "border-slate-100 bg-white text-slate-800 translate-y-2 opacity-60")}>
        ...
        <div className="min-w-0">
          ...
          <p className={clsx("text-xs", stage === 2 ? "text-slate-400" : "text-slate-400")}>Reunião com a equipa em 15 minutos</p>
        </div>
      </div>
...
function MeetingFlowDemo() {
  ...
  const steps = [
    ["Reunião criada", "Equipa Comercial · hoje, 14:00"],
    ["Convites enviados", "Carla, Pedro e Marina confirmados"],
    ["Google Meet em curso", "3 participantes · 32 minutos"],
    ["Ata pronta pela IA", "Decisões e próximos passos organizados"],
  ];
  return (
    <div ref={ref} className="relative mx-auto w-full max-w-md">
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-2xl shadow-slate-900/10">
        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4"><div><p className="text-sm font-extrabold text-slate-900">Reunião · Equipa Comercial</p><p className="text-[11px] text-slate-400">Fluxo automatizado pelo Zelo</p></div><span className={clsx("h-2.5 w-2.5 rounded-full", stage === 2 ? "animate-pulse bg-red-500" : "bg-emerald-500")} /></div>
        <div className="p-5">
          ...
          <div className={clsx("mt-4 overflow-hidden rounded-2xl bg-slate-950 p-4 text-white transition-all duration-500", stage === 3 ? "max-h-36 opacity-100" : "max-h-0 p-0 opacity-0")}>
            <p className="text-[10px] font-bold uppercase tracking-wide text-amber-400">Resumo da IA</p><p className="mt-2 text-xs leading-relaxed text-slate-300">Decidido: fechar a proposta até sexta-feira. A Carla envia o contrato revisto. Próxima reunião na quinta-feira.</p>
          </div>
        </div>
      </div>
    </div>
...
function InvoiceImportDemo() {
  ...
  const steps = [
    ...
    ["IA a ler lançamentos", "34 itens identificados", "✦"],
    ["Duplicados comparados", "5 compras já registadas", "↻"],
    ["Pronto a confirmar", "29 lançamentos novos", "✓"],
  ];
  return (
    <div ref={ref} className="grid gap-5 lg:grid-cols-[.85fr_1.15fr]">
      ...
      <div className="overflow-hidden rounded-[2rem] bg-slate-950 p-6 text-white sm:p-8">
        ...
        <div className={clsx("mt-5 rounded-2xl border p-4 transition-all duration-500", stage === 3 ? "border-emerald-400/30 bg-emerald-400/10 opacity-100" : "border-white/10 bg-white/[0.03] opacity-55")}><div className="flex items-center justify-between gap-4"><div><p className="text-sm font-bold">Revisão concluída</p><p className="mt-1 text-[11px] text-slate-400">Nada é importado sem a tua aprovação.</p></div><span className={clsx("rounded-xl px-4 py-2 text-xs font-extrabold transition", stage === 3 ? "bg-emerald-400 text-slate-950" : "bg-white/10 text-slate-500")}>Confirmar</span></div></div>
      </div>
    </div>
  );
}
      ...
      <div className="bg-slate-950 px-5 pt-2 pb-4">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800/60 border border-white/[0.06] p-4 mb-3">
          ...
          <svg viewBox="0 0 200 46" className="w-full h-9 mt-2" preserveAspectRatio="none">
            <defs>
              <linearGradient id="sparkFillPt" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#fbbf24" stopOpacity="0.35" />
                <stop offset="100%" stopColor="#fbbf24" stopOpacity="0" />
              </linearGradient>
            </defs>
            <path d="M0 34 L28 30 L56 36 L84 20 L112 24 L140 10 L168 15 L200 4 V46 H0 Z" fill="url(#sparkFillPt)" />
  ...
  return (
    <div className="relative mx-auto flex min-h-[570px] w-full max-w-[420px] items-center justify-center">
      ...
      <div className="absolute left-0 top-20 z-20 hidden rounded-2xl border border-slate-200 bg-white/95 p-3 shadow-xl backdrop-blur sm:block">
        <p className="text-[10px] font-bold uppercase tracking-wide text-slate-400">Despesa registada</p>
...
function ModeToggleDemo() {
  ...
  return (
    <div className="max-w-sm mx-auto relative">
      ...
      <p className="text-center text-[11px] text-slate-400 mt-3">↑ clica para alternar entre os modos</p>
    </div>
  );
}
...
const MODE_BENEFITS = {
  personal: {
    label: "Modo Pessoal",
    eyebrow: "A tua vida em ordem",
    description: "Cuida das contas de casa, dos compromissos e dos objetivos pessoais sem depender de folhas de cálculo ou várias aplicações.",
    benefits: [
      ["Finanças pessoais", "Receitas, despesas, faturas e prestações organizadas automaticamente."],
      ["Agenda e tarefas", "Compromissos, tarefas e lembretes criados pela conversa."],
      ["Metas e recorrências", "Acompanha objetivos e não te esqueças de contas que se repetem."],
      ["Casa e família", "Lista de supermercado, veículos e números familiares ilimitados."],
      ["Documentos importantes", "Guarda comprovativos e encontra tudo por significado."],
      ["Visão de quem registou", "Sabe qual pessoa da família adicionou cada informação."],
    ],
  },
  business: {
    label: "Modo Empresa",
    eyebrow: "O teu negócio sob controlo",
    description: "Centraliza a operação do dia a dia e acompanha o que entra, o que sai e o que a tua equipa precisa de fazer.",
    benefits: [
      ["Financeiro empresarial", "Caixa, contas a pagar e receber, faturas e categorias do negócio."],
      ["Clientes organizados", "Regista contactos, empresas, telefones, moradas e observações."],
      ["Equipa e folha salarial", "Funcionários, cargos, salários e pagamentos recorrentes num só lugar."],
      ...
      ["Sócios e equipa", "Cada pessoa usa o próprio WhatsApp, com acesso definido por modo."],
    ],
  },
} as const;
    ...
    <section id="modo" className="relative overflow-hidden bg-slate-950 py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className={`${heading.className} mt-5 text-3xl font-extrabold text-white sm:text-5xl`}>A tua vida pessoal e a tua empresa, cada uma no seu lugar.</h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-400">Alternas o modo no painel ou pelo WhatsApp. Saldos, categorias, metas e relatórios permanecem separados para não misturares a casa com o negócio.</p>
        </div>
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-2xl shadow-slate-900/10">
        ...
        <div className="p-5 sm:p-6">
          <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
            ...
            <p className="flex-1 truncate text-sm text-slate-700">comprovativo do mecânico deste ano</p>
          ...
          <div className="mt-5 min-h-[265px]">
            <div className={clsx("rounded-2xl border p-4 transition-all duration-500", stage === 0 ? "translate-y-0 border-amber-200 bg-amber-50 opacity-100" : "-translate-y-2 border-slate-100 bg-slate-50 opacity-45")}>
              <div className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-lg shadow-sm">📄</span><div className="min-w-0 flex-1"><p className="truncate text-sm font-bold text-slate-800">comprovativo_mecanico.pdf</p><p className="text-[11px] text-slate-400">Recebido pelo WhatsApp · agora</p></div><span className="text-xs font-bold text-amber-600">A enviar</span></div>
            </div>
            ...
            <div className={clsx("mt-3 rounded-2xl border p-4 transition-all duration-500", stage === 1 ? "scale-100 border-sky-200 bg-sky-50 opacity-100" : "scale-[.98] border-slate-100 bg-white opacity-45")}>
              <div className="flex items-center justify-between"><div><p className="text-xs font-bold uppercase tracking-wide text-sky-600">IA a analisar</p><p className="mt-1 text-sm font-bold text-slate-800">Comprovativo identificado</p></div><span className="rounded-full bg-sky-100 px-2.5 py-1 text-[10px] font-bold text-sky-700">Comprovativos</span></div>
            ...
            <div className={clsx("mt-3 rounded-2xl border p-4 transition-all duration-500", stage === 2 ? "translate-y-0 border-emerald-200 bg-emerald-50 opacity-100 shadow-lg shadow-emerald-500/10" : "translate-y-2 border-slate-100 bg-white opacity-45")}>
              <div className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-100 text-emerald-700">✓</span><div className="min-w-0 flex-1"><p className="text-[10px] font-bold uppercase tracking-wide text-emerald-600">Encontrado pela pesquisa</p><p className="truncate text-sm font-bold text-slate-800">Comprovativo · Oficina Mecânica</p><p className="text-[11px] text-slate-400">PDF · pasta Comprovativos</p></div></div>
            </div>
          </div>
...
const FINANCAS_DETAILS: Detail[] = [
  { icon: FEATURE_ICONS.mic, title: "Áudio, texto ou foto", desc: "Fala naturalmente, escreve ou envia uma foto do recibo — os três formatos são entendidos na hora." },
  { icon: FEATURE_ICONS.tag, title: "Categorização automática", desc: "Cada despesa já chega organizada por categoria, sem escolher nada à mão." },
  { icon: FEATURE_ICONS.repeat, title: "Recorrentes e a prestações", desc: "Assinaturas e prestações com lembrete automático em cada vencimento." },
  { icon: FEATURE_ICONS.switch, title: "Pessoal ou empresa", desc: "Regista no modo certo e nunca misturas as contas de casa com as do negócio." },
];

const PAINEL_DETAILS: Detail[] = [
  { icon: FEATURE_ICONS.chart, title: "Categorias à tua medida", desc: "Cria e edita as tuas próprias categorias, da forma que fizer sentido para ti." },
  { icon: FEATURE_ICONS.clock, title: "Lançamentos pendentes", desc: "Contas futuras entram automaticamente no saldo assim que chega a data." },
  { icon: FEATURE_ICONS.target, title: "Metas com prazo", desc: "Define o valor alvo e a data, acompanha o progresso quando quiseres." },
  { icon: FEATURE_ICONS.pencil, title: "Edita a conversar", desc: "Muda o valor, a categoria ou a data só descrevendo o que precisas de mudar." },
];

const AGENDA_DETAILS: Detail[] = [
  { icon: FEATURE_ICONS.chat, title: "Fala à tua maneira", desc: "Diz a data e a hora como preferires — o Zelo entende e agenda certinho." },
  ...
  { icon: FEATURE_ICONS.bell, title: "Lembretes automáticos", desc: "És avisado antes de cada compromisso, sem configurar nada." },
  { icon: FEATURE_ICONS.check, title: "Tarefas do dia", desc: "Marca compromissos e afazeres como feitos diretamente pelo WhatsApp." },
];

const REUNIOES_DETAILS: Detail[] = [
  { icon: FEATURE_ICONS.link, title: "Link em segundos", desc: "Pede e o Zelo cria o Google Meet na hora, sem abrir o Google Agenda." },
  { icon: FEATURE_ICONS.megaphone, title: "Convite automático", desc: "Participantes chamados diretamente pelo WhatsApp, sem trabalho manual." },
  { icon: FEATURE_ICONS.doc, title: "Ata gerada por IA", desc: "No final, o Zelo resume decisões e próximos passos automaticamente." },
  { icon: FEATURE_ICONS.search, title: "Fácil de encontrar depois", desc: "A ata fica guardada e pode ser consultada quando quiseres." },
];

const CONTA_DETAILS: Detail[] = [
  { icon: FEATURE_ICONS.users, title: "Casais", desc: "Registem as despesas da casa numa só conta, sem duplicar o controlo." },
  { icon: FEATURE_ICONS.partners, title: "Sócios", desc: "Lancem despesas e receitas da empresa no mesmo lugar, em modo empresa." },
  { icon: FEATURE_ICONS.lock, title: "Sem partilhar senha", desc: "Cada pessoa usa o próprio número de WhatsApp, com segurança." },
  { icon: FEATURE_ICONS.tag, title: "Identificado por pessoa", desc: "Todo o lançamento mostra quem da família ou da equipa registou." },
];

const DRIVE_DETAILS: Detail[] = [
  { icon: FEATURE_ICONS.upload, title: "Envia qualquer ficheiro", desc: "Diretamente pelo WhatsApp, sem aplicação extra e sem iniciar sessão em lado nenhum." },
  { icon: FEATURE_ICONS.folder, title: "Organização automática", desc: "O Zelo entende o conteúdo e guarda na pasta certa sozinho." },
  { icon: FEATURE_ICONS.search, title: "Pesquisa por significado", desc: "Descreve o que procuras, mesmo sem te lembrares do nome — a IA encontra." },
  { icon: FEATURE_ICONS.pencil, title: "Renomeia a conversar", desc: "Pede para renomear o último ficheiro só escrevendo o novo nome." },
];

const FAQS = [
  { q: "O que é o Zelo e como é que funciona?", a: "O Zelo é um assistente pessoal por IA que vive no teu WhatsApp. Falas, escreves ou envias uma foto do que precisas de registar — finanças, compromissos, tarefas — e ele organiza tudo automaticamente, com um painel web para acompanhares sempre que quiseres." },
  { q: "Preciso de instalar alguma aplicação?", a: "Não. Todo o dia a dia acontece no teu WhatsApp normal, sem instalar nada. O painel web é opcional, para quando quiseres uma visão mais completa." },
  { q: "Como funciona o Modo Pessoal e o Modo Empresa?", a: "É a mesma conta e o mesmo WhatsApp, mas com dois ambientes separados: um para a vida pessoal e outro para a empresa. Trocas de modo com um clique no painel (ou pedindo ao Zelo), e cada um tem o seu próprio saldo, categorias e metas — sem misturar as contas." },
  { q: "Como funciona a importação da fatura do cartão?", a: "Envia o PDF da fatura pelo WhatsApp (ou pelo painel) e o Zelo lê cada lançamento sozinho, categoriza automaticamente e avisa quando alguma despesa já foi registada antes — assim nunca duplicas uma compra." },
  { q: "Posso partilhar a minha conta com outras pessoas?", a: "Sim. Podes associar o número da família, sócios ou da tua equipa à mesma conta — cada um regista pelo próprio WhatsApp, identificado pelo nome, e tudo cai no mesmo painel." },
  { q: "O que acontece com as minhas reuniões do Google Meet?", a: "Podes pedir ao Zelo para criar o link da reunião, convocar os participantes pelo WhatsApp e, quando terminar, ele gera automaticamente uma ata com os pontos principais discutidos." },
  { q: "Como funciona o Drive Inteligente?", a: "Envia qualquer ficheiro pelo WhatsApp e o Zelo guarda-o na pasta certa sozinho. Depois, é só descrever o que procuras — \"encontra o comprovativo do mecânico\" — que ele encontra por ti." },
  { q: "Os meus dados estão seguros?", a: "Sim. Os teus dados ficam associados à tua conta e nunca são partilhados entre utilizadores diferentes — cada família, sócio ou equipa só vê a própria informação." },
  { q: "Como funciona a garantia?", a: "A tua primeira compra tem 7 dias de garantia. Dentro desse prazo, podes solicitar o cancelamento e a devolução do valor através da plataforma da Hotmart." },
];
    ...
    <section className="bg-slate-950 py-24">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-10">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 border border-white/10 text-slate-300 text-xs font-semibold px-3 py-1.5">Esclarece as tuas dúvidas</span>
          <h2 className={`${heading.className} text-3xl sm:text-4xl font-extrabold text-white mt-4`}>Perguntas frequentes</h2>
          <p className="text-slate-400 mt-3 text-sm">Tudo o que precisas de saber sobre o Zelo antes de começares.</p>
        </div>
...
const DEMO_SCENARIOS = {
  business: {
    ...
    response: "Pronto! Registei R$ 87,00 em Combustível no modo Empresa.",
    tags: ["Modo Empresa", "Combustível"],
    resultLabel: "Painel atualizado",
    resultTitle: "Despesa da empresa",
    resultMeta: "Combustível · hoje",
    resultValue: "− R$ 87,00",
    proof: "O teu saldo pessoal não foi alterado.",
  },
  invoice: {
    tab: "Importar fatura",
    icon: "📄",
    tabDescription: "PDF organizado pela IA",
    userMessage: "Importa esta fatura em PDF por mim",
    response: "Fatura lida! Encontrei 34 compras e separei 5 que já estavam registadas.",
    tags: ["29 despesas novas", "5 duplicadas"],
    resultLabel: "Importação pronta",
    resultTitle: "Fatura de julho",
    resultMeta: "Revê antes de confirmar",
    resultValue: "34 itens",
    proof: "Nada é duplicado ou importado sem a tua aprovação.",
  },
  calendar: {
    tab: "Agenda e lembretes",
    icon: "📅",
    tabDescription: "Compromissos no automático",
    userMessage: "Marca reunião amanhã às 10h e lembra-me antes",
    response: "Reunião marcada para amanhã, às 10h. Vou lembrar-te 15 minutos antes.",
    tags: ["Google Agenda", "Lembrete criado"],
    resultLabel: "Agenda sincronizada",
    resultTitle: "Reunião",
    resultMeta: "Amanhã · 10:00",
    resultValue: "15 min antes",
    proof: "Compromisso e lembrete criados numa só conversa.",
  },
} as const;
  ...
  return (
    <section id="como-funciona" className="relative overflow-hidden bg-white py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex rounded-full border border-amber-200 bg-amber-50 px-3 py-1.5 text-xs font-bold text-amber-700">VÊ NA PRÁTICA</span>
          <h2 className={`${heading.className} mt-5 text-3xl font-extrabold text-slate-950 sm:text-5xl`}>Vê o Zelo a trabalhar por ti.</h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-500">Escolhe uma situação e acompanha como uma mensagem se transforma em organização no WhatsApp e no painel.</p>
        </div>
        ...
        >
          <div className="relative border-b border-white/10 p-6 sm:p-9 lg:border-b-0 lg:border-r">
            ...
            <div className="relative mt-5 flex items-center justify-center gap-2 text-[11px] font-semibold text-slate-500">
              <span>Tu envias</span><span className="text-amber-400">→</span><span>a IA entende</span><span className="text-amber-400">→</span><span>o painel atualiza</span>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center p-6 sm:p-9 lg:p-10">
            ...
            <a href="#planos" className="mt-6 rounded-xl bg-gradient-to-br from-amber-400 to-amber-500 px-6 py-3.5 text-center text-sm font-extrabold text-slate-950 shadow-lg shadow-amber-500/10 transition hover:opacity-90">Quero organizar a minha rotina →</a>
            <p className="mt-3 text-center text-[11px] text-slate-500">Começa em poucos minutos · 7 dias de garantia</p>
          </div>
        </div>
      </div>
    </section>
...
// oferta separado em português europeu na Hotmart. Trocar aqui quando o
// produto existir, senão a compra continua indo pro checkout brasileiro.
const PLAN_OPTIONS = [
  {
    id: "monthly",
    label: "Mensal",
    ...
    <section id="planos" className="relative overflow-hidden bg-slate-50 py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-base text-slate-500">Todos os planos desbloqueiam o Zelo completo para uso pessoal e empresarial, com quantos números da família quiseres.</p>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-[2rem] border border-slate-200 bg-white p-7 shadow-lg shadow-slate-900/5 sm:p-8">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <h3 className={`${heading.className} text-lg font-extrabold text-slate-950 sm:text-xl`}>O que está incluído</h3>
          ...
          <ul className="mt-6 grid gap-x-8 gap-y-4 sm:grid-cols-2">
            {[
              "O teu Assessor no WhatsApp",
              "Painel completo do teu Assessor",
              "Gestão partilhada",
              "Lembretes ilimitados",
              "Controlo total das finanças",
              "Controlo total da agenda — com integração no Google Agenda",
              "Controlo total de tarefas e projetos",
              "Gestão de ficheiros",
              "E muito mais",
            ].map(feature => (
          ...
          {PLAN_OPTIONS.map(option => (
            <article key={option.id} className={clsx("relative flex flex-col rounded-[2rem] border bg-white p-7 transition duration-300 hover:-translate-y-1 hover:shadow-2xl sm:p-8", option.id === "semiannual" ? "border-amber-300 shadow-xl shadow-amber-500/10" : "border-slate-200 shadow-lg shadow-slate-900/5")}>
              ...
              <ul className="flex-1 space-y-3.5">
                {["Acesso a todas as funcionalidades", "Painel completo e personalizado", "Zelo no WhatsApp", "Uso pessoal e empresarial", "Números ilimitados para a família", "Suporte prioritário"].map(feature => (
        ...
        <p className="mt-7 text-center text-xs text-slate-400">Vais poder escolher entre uso pessoal ou empresarial ao criares a conta. As funcionalidades são as mesmas em todos os períodos.</p>
      </div>
    </section>
  );
}
    ...
    <div className={`${heading.variable} overflow-x-hidden bg-white`}>
      ...
      <header className="sticky top-0 z-40 bg-slate-950/90 backdrop-blur border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/pt/login" className="hidden sm:block text-sm text-slate-300 hover:text-white transition">Entrar</Link>
        ...
        {menuOpen && (
          <nav className="border-t border-white/10 bg-slate-950 px-6 py-5 md:hidden" aria-label="Navegação móvel">
            <div className="mx-auto grid max-w-7xl gap-1 text-sm text-slate-300">
              ...
              <Link href="/pt/login" className="mt-2 rounded-xl border border-white/10 px-3 py-3 text-center font-bold text-white">Entrar na minha conta</Link>
            </div>
          </nav>
        )}
      </header>
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-16 pb-20 grid md:grid-cols-2 gap-14 items-center">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full bg-white/5 border border-white/10 text-slate-300 text-xs font-semibold px-3 py-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-amber-400" /> IA no WhatsApp para a tua rotina
            </span>
            <h1 className={`${heading.className} text-4xl sm:text-6xl font-extrabold text-white mt-5 leading-[1.05]`}>
              Organiza o teu negócio e a tua vida pessoal pelo WhatsApp —{" "}
            ...
            <p className="text-slate-400 mt-5 text-[16px] leading-relaxed max-w-md">
              Envia áudios, fotos, faturas ou mensagens. O Zelo organiza finanças, agenda, tarefas e documentos em modos separados para ti e para a tua empresa.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-x-5 gap-y-1.5 text-xs text-slate-500">
              <span>🎙️ Regista por áudio</span>
              <span>⚡ Consulta em segundos</span>
              <span>📋 Organiza tudo no painel</span>
            </div>
          </div>

          <WhatsAppMock
            chips={[
              { label: "💸 Despesa categorizada", pos: "-left-8 top-10" },
              { label: "📅 Compromisso marcado", pos: "-right-6 bottom-24", delay: "1.4s" },
            ]}
            messages={[
              { from: "user", time: "20:40", text: "Bom dia, organizas o meu dia?" },
              { time: "20:40", text: <>Claro! Vou cuidar da tua <b>agenda</b>, <b>finanças</b> e prioridades num só lugar.</> },
              { time: "20:40", tags: ["Resumo", "Rotina"], text: `📆 A passar rapidamente:\nVi R$ 87,40 no cartão hoje.\n\nJá categorizei, guardei no painel e deixei tudo bonito por lá ✨` },
              { from: "user", time: "20:41", text: "Marca reunião amanhã 10h com a Carla" },
              { time: "20:41", tags: ["Google Agenda", "Lembrete criado"], text: "Marcado! ✅ Vou lembrar-te 15 min antes." },
            ]}
          />
        </div>
      ...
      <div id="financas">
        <Feature
          ...
          title="Regista as tuas despesas por áudio, texto ou foto."
          desc="Regista cada despesa ou receita em segundos. O Zelo ouve os teus áudios, entende a tua fala natural e categoriza tudo automaticamente — sem folha de cálculo, sem digitar."
          details={FINANCAS_DETAILS}
          visual={
            <ScreenChatDemo
              messages={[
                { from: "user", time: "09:08", typed: "Gastei 45 no supermercado", text: "Gastei 45 no supermercado" },
                { time: "09:08", tags: ["Alimentação", "Categorizado"], text: `💸 Despesa registada!\n${fmt(45)} — Supermercado` },
                { from: "user", time: "09:10", typed: "Recebi 1200 de um trabalho freelance", text: "Recebi 1200 de um trabalho freelance" },
                { time: "09:10", tags: ["Receita", "Categorizado"], text: `💰 Receita registada!\n${fmt(1200)} — Freelance` },
              ]}
            />
          }
        />
      ...
      <Feature
        eyebrow="📊 O Teu Painel Financeiro"
        reverse
        tint
        title="O teu dinheiro organizado num só painel."
        desc="As tuas despesas, compromissos e metas organizados num painel completo. Sabes sempre o que aconteceu, o que está pendente e o que vem a seguir."
      ...
      <section id="fatura" className="relative overflow-hidden bg-white py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className={`${heading.className} text-3xl sm:text-4xl font-extrabold text-slate-900 mt-4`}>Chega de digitar cada despesa do cartão.</h2>
            <p className="text-slate-500 mt-3 text-sm leading-relaxed">Envia a fatura em PDF pelo WhatsApp ou pelo painel. O Zelo lê cada lançamento, categoriza automaticamente e nunca regista a mesma despesa duas vezes.</p>
          </div>

          <InvoiceImportDemo />

          <div className="text-center mt-10">
            <Link href="/pt/cadastro" className="inline-block rounded-xl bg-gradient-to-br from-amber-500 to-amber-500 text-white text-sm font-bold px-6 py-3.5 hover:opacity-90 transition shadow-lg shadow-amber-500/20">
              Importar a minha fatura →
            </Link>
          </div>
        </div>
      </section>
      ...
      <div id="agenda">
        <Feature
          ...
          tint
          title="Nunca mais te esqueças de um compromisso."
          desc="Tens lembretes e resumos diários. Regista compromissos no WhatsApp falando à tua maneira: o Zelo entende e organiza a tua rotina. Tudo sincronizado com o Google Agenda."
      ...
      <Feature
        ...
        desc="Pede ao Zelo para criar o link do Google Meet, convocar os participantes pelo WhatsApp e, quando a reunião terminar, ele mesmo gera a ata com os pontos principais."
        details={REUNIOES_DETAILS}
        visual={<MeetingFlowDemo />}
      />

      {/* ── GRELHA DE MÓDULOS SECUNDÁRIOS ── */}
      <section className="relative overflow-hidden bg-slate-950 py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-12">
            ...
            <h2 className={`${heading.className} text-3xl sm:text-4xl font-extrabold text-white mt-4`}>Muito mais do que finanças.</h2>
            <p className="text-slate-400 mt-3 text-sm">Tudo o que organiza a tua rotina — pessoal ou da empresa — num só assistente.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-5">
            {[
              { icon: MODULE_ICONS.bell, title: "Lembretes", desc: "Avisos únicos, diários, semanais ou mensais — o Zelo chama-te na hora certa." },
              { icon: MODULE_ICONS.target, title: "Metas", desc: "Define objetivos com valor alvo e prazo, e acompanha quanto falta para lá chegar." },
              { icon: MODULE_ICONS.car, title: "Veículos", desc: "Combustível, manutenção, seguro e quilometragem de cada veículo, tudo num lugar." },
              { icon: MODULE_ICONS.users, title: "Funcionários", desc: "Cargo, salário e estado de cada funcionário da tua empresa, sempre à mão." },
              { icon: MODULE_ICONS.cart, title: "Lista de supermercado", desc: "Compras por categoria, preço, quantidade e loja, diretamente pelo WhatsApp." },
            ].map(c => (
      ...
      {/* ── CONTA PARTILHADA ── */}
      <Feature
        eyebrow="👨‍👩‍👧 Conta Partilhada"
        tint
        title="Convida quem precisares, sem senha."
        desc="Partilha o Zelo com a tua família, sócios ou equipa. Cada pessoa regista pelo próprio WhatsApp, e mantens visibilidade total sobre tudo num só painel."
        ...
        visual={
          <div className="relative w-full max-w-sm mx-auto aspect-square flex items-center justify-center">
            ...
            {[
              ...
              { label: "Pedro · Marido", pos: "bottom-2 left-8" },
              { label: "Marina · Equipa", pos: "bottom-6 right-6" },
            ].map((p, i) => (
      ...
      <div id="drive">
        <Feature
          ...
          reverse
          title="Os teus documentos guardados. Encontrados por IA."
          desc="Envia qualquer ficheiro pelo WhatsApp e tem tudo guardado e organizado. Quando precisares, é só descrever com as tuas palavras que o Zelo encontra por ti."
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-400 to-amber-500 py-24">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className={`${heading.className} text-3xl sm:text-5xl font-extrabold text-slate-900`}>A tua rotina, sob controlo.</h2>
          <p className="text-slate-800/80 mt-3 text-lg">Pessoal ou empresa — onde quer que estejas, é só abrir o WhatsApp.</p>
      ...
      <footer className="bg-slate-950 border-t border-white/5 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center sm:items-start gap-1.5">
            ...
            <p className="text-slate-500 text-xs">Gestão inteligente, diretamente no WhatsApp.</p>
          </div>
      ...
      <div className="fixed inset-x-3 bottom-3 z-50 rounded-2xl border border-white/10 bg-slate-950/95 p-2 shadow-2xl backdrop-blur md:hidden">
        <a href="#planos" className="flex items-center justify-center rounded-xl bg-amber-400 px-5 py-3.5 text-sm font-extrabold text-slate-950">Escolher o meu plano →</a>
      </div>
    </div>
  );
}
