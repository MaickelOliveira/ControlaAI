  ...
  return (
    <div className="max-w-lg space-y-5">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5">
        <h2 className="font-semibold text-slate-900 mb-4">🔐 Alterar Senha Admin</h2>
        <form onSubmit={saveAdmin} className="space-y-3">
          ...
          <button type="submit" className="w-full bg-emerald-600 hover:bg-emerald-500 text-slate-900 font-semibold rounded-xl py-2.5 text-sm transition">
            Salvar
          </button>
        </form>
      </div>
