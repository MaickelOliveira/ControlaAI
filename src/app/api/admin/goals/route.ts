...
export async function POST(req: NextRequest) {
  ...
  const goal = await createGoal({ userId: session.sub, title, targetAmount, currentAmount: currentAmount || 0, deadline, category: category || "Geral", mode: mode || "personal", status: "active" });
